  ...
  return (
    <main className="w-full bg-black text-white">
      <div className="relative w-full h-screen md:bottom-0 bottom-10 overflow-hidden bg-black text-white">
        ...
        <div className="absolute mb-25 md:mb-0 bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-10 animate-bounce pointer-events-none select-none">
